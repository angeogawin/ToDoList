...
public class SwipeMenuListView extends ListView {
    ...
    private com.dev.ogawin.swipemenulistview.SwipeMenuLayout mTouchView;
    private OnSwipeListener mOnSwipeListener;

    private com.dev.ogawin.swipemenulistview.SwipeMenuCreator mMenuCreator;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (view instanceof com.dev.ogawin.swipemenulistview.SwipeMenuLayout) {
                    //如果有打开了 就拦截.
                    if (mTouchView != null && mTouchView.isOpen() && !inRangeOfView(mTouchView.getMenuView(), ev)) {
                        return true;
                    }
                    mTouchView = (com.dev.ogawin.swipemenulistview.SwipeMenuLayout) view;
