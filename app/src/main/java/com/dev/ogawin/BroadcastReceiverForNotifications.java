...
public class BroadcastReceiverForNotifications extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        PendingIntent pIntent = PendingIntent.getActivity(context, (int) System.currentTimeMillis(), intentNotif, 0);
    ...
    public void planifierProchaineAlarme(Context context,Intent intent,String recurrence)
    {
        ...
        if(calendar != null)
        {
            ...
            alarmIntent = PendingIntent.getBroadcast(context, idRappel, intent, 0);
